      ...
      <div className="rounded-2xl border border-[#d7e2fb] bg-white/75 p-4 backdrop-blur-md dark:border-slate-700 dark:bg-slate-900/65 md:p-5">
        <div className="mb-5 flex flex-col gap-4 rounded-2xl border border-[#d4e0fb] bg-[#eef3ff]/85 p-4 dark:border-slate-700 dark:bg-slate-900/70 md:flex-row md:items-center md:justify-between">
          <div className="space-y-1">
            <p className="text-lg font-semibold text-slate-950 dark:text-white">Ready to split rent with full transparency?</p>
            <p className="text-sm text-slate-600 dark:text-slate-300">Connect wallet, pay, and verify each transfer hash in one flow.</p>
          </div>
        ...
        <div className="grid gap-6 md:grid-cols-[1.2fr_repeat(3,minmax(0,1fr))]">
          <div className="space-y-3">
            ...
            <p className="max-w-sm text-sm text-muted-foreground">
              Built for roommates and shared households managing recurring rent transfers and escrow milestones.
            </p>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#features" className="hover:text-foreground transition-colors">Feature overview</a></li>
              <li><a href="#workflow" className="hover:text-foreground transition-colors">Transfer workflow</a></li>
              <li><a href="#service-info" className="hover:text-foreground transition-colors">Service details</a></li>
              <li><Link href="/dashboard" className="hover:text-foreground transition-colors">Dashboard shell</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <a href="https://developers.stellar.org" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
                  Stellar developer docs
                </a>
              </li>
              <li>
                <a href="https://stellar.expert" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
                  Stellar explorer
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">Use Cases</p>
            <ul className="space-y-2 text-sm text-muted-foreground">
